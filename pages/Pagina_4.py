...
def main():
    ...
    retornos = [portfolio_ret_anual_ajustado * 100, ret_anual_sp500 * 100, ret_anual_ibov * 100, ret_anual_cdi * 100, ret_anual_ipca * 100]
    volatilidades = [port_vol_ajustado * 100, vol_sp500 * 100, vol_ibov * 100, vol_cdi * 100, vol_ipca * 100]
